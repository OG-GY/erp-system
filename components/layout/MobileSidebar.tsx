    ...
    <>
      <header className="flex h-14 shrink-0 items-center gap-3 border-b border-border bg-surface-translucent px-4 backdrop-blur-xl md:hidden">
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-sm text-foreground hover:bg-overlay-hover"
        >
        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          >
            <button
              ...
              aria-label="Close menu"
              onClick={() => setOpen(false)}
              className="absolute right-2 top-2 flex h-9 w-9 items-center justify-center rounded-sm text-foreground hover:bg-overlay-hover"
            >
